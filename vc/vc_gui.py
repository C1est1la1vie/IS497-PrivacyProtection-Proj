...
def show_visual_crypt(obj):
    ...
    obj.right_layout2.addWidget(obj.text_str, 3, 5, 1, 4)
    obj.labl_str = QtWidgets.QLabel('')
    obj.right_layout2.addWidget(obj.labl_str, 7, 5, 2, 4)
    ...
    obj.right_layout2.addWidget(obj.button_qrenc, 6, 3, 1, 2)
    ...
    obj.right_layout2.addWidget(obj.button_vcenc, 6, 5, 1, 2)
    ...
    obj.right_layout2.addWidget(obj.button_vcdec, 6, 7, 1, 2)
    ...
    obj.right_layout2.addWidget(obj.button_qrdec, 6, 9, 1, 2)
